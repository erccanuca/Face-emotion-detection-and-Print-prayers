...
namespace DuamatikAndFaceEmotionRecognition
{
    public partial class Form1 : Form
    {
        ...
        public static string emotionResult = "";
        ...
        public Form1()
        {
            ...
            Load += new EventHandler(mainWinForm_Load);
        }
        WebCam webcam;
        private void mainWinForm_Load(object sender, EventArgs e)
        {
            ...
            webcam = new WebCam();
            webcam.InitializeWebCam(ref pictureBox_Main);
            webcam.Start();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = pictureBox_Main.Image;
            contrast_function();
        ...
        private void connected_area()
        {
            ...
            pictureBox2.Image = pictureBox_Main.Image;
        ...
        private void detect_face()
        {
            ...
            if ((Ratio >= 0.75 && Ratio <= 2.0) && newHeight >= 50 && newWeight >= 50)
            {
                Form2 a = new Form2();
                a.pic(b);
